...
const {
    ...
    getOneByIdBD,
    addTemperaments,
    capitalizar} = require ('../controller/functions')
...
router.delete('/:idRaza', async (req,res)=> {  // ruta para encontrar una raza en particular (el front me manda la id), 
...
router.put('/:idRaza', async (req,res)=> {  // ruta para encontrar una raza en particular (el front me manda la id), 
